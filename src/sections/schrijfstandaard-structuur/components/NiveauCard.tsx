...
import type { DocumentNiveau, DocumentType } from '@/../product/sections/schrijfstandaard-structuur/types'
  ...
  return (
    <div
      className={`
        ...
        ${isSelected
          ? `${kleuren.bg} ${kleuren.border} ring-2 ring-offset-2 ring-${niveau.kleur}-400`
