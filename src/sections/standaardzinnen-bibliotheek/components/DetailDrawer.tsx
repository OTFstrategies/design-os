...
import type { Standaardzin, AtomairSequentie, Categorie, DocumentRef } from '@/../product/sections/standaardzinnen-bibliotheek/types'
...
export function DetailDrawer({
  ...
  void _onEdit // Available for future use
