...
import type { AgentStap, Agent, AgentStapStatus, PipelineVisualisatieProps } from './types'
    ...
    return (
      <div className="flex items-center gap-1 flex-wrap">
        ...
        <div className="flex flex-col gap-0.5">
          <StapChip stap={stap1A} nummer="1A" />
          <StapChip stap={stap1B} nummer="1B" />
        </div>
        <Arrow compact />
        {sequentialStappen.map(({ stap, nummer }, index) => (
          <div key={nummer} className="flex items-center gap-1">
            <StapChip stap={stap} nummer={nummer} />
